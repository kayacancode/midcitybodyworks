    ...
    <div className="min-h-screen bg-gray-100 flex flex-col">
      ...
      <section id="appointment" className="w-full max-w-4xl bg-white p-6 rounded-lg shadow-md mt-6">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
            <label htmlFor="vechiclevin" className="block text-sm font-medium text-gray-700">Phone</label>
              <input
                type="vechiclevin"
                name="vechiclevin"
                id="vechiclevin"
            ...
            <div>
            <label htmlFor="licenseplate" className="block text-sm font-medium text-gray-700">Phone</label>
              <input
                type="licenseplate"
                name="licenseplate"
                id="licenseplate"
