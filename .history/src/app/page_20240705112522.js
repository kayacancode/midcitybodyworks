        ...
        <section className="w-full max-w-4xl bg-white p-6 rounded-lg shadow-md mt-6">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
            <div className="bg-[#800001] p-4 rounded">
              <h3 className="font-bold text-white">Auto Body and Paint Repair</h3>
            </div>
            <div className="bg-[#800001] p-4 rounded">
              <h3 className="font-bold text-white">Frame and Unibody Correction</h3>
            </div>
            <div className="bg-[#800001] p-4 rounded">
              <h3 className="font-bold text-white">Theft Restoration</h3>
            </div>
            <div className="bg-[#800001] p-4 rounded">
              <h3 className="font-bold text-white">Painting and Tape Pin-striping</h3>
            </div>
            <div className="bg-[#800001] p-4 rounded">
              <h3 className="font-bold text-white ">Suspension Repair</h3>
            </div>
            <div className="bg-[#800001] p-4 rounded">
              <h3 className="font-bold text-white ">Glass Replacement</h3>
            </div>
          </div>
