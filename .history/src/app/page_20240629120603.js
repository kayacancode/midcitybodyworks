...
export default function Home() {
  return (
    <div className="min-h-screen bg-gray-100 flex flex-col">
      {/* Navigation Bar */}
      <header className="bg-blue-600 text-white w-full py-4 flex justify-between items-center px-6">
        <div className="text-2xl font-bold">Midcity Body Works</div>
        <nav>
      ...
      <main className="flex flex-col items-center p-6">
        <section id="home" className="w-full bg-white p-6 rounded-lg shadow-md mt-6 text-center">
          <h1 className="text-4xl font-bold text-red-600">Midcity Body Works</h1>
        </section>
